package kchandra423.graphics.shapes;
...
//	 y=centerY;
 ...
 public void draw(PApplet pad) {
	 pad.pushStyle();
	 super.draw(pad);
	 pad.circle((float)getX(),(float)getY(),(float)diameter);
	 pad.popStyle();
 }
 /**
...
public Rectangle getBoundingRectangle() {
	// TODO Auto-generated method stub
	return new Rectangle(getX()-getRadius(), getY()-getRadius(), diameter, diameter);
}
@Override
